...
/**
 * from https://github.com/tips4java/tips4java/blob/main/source/TableColumnAdjuster.java
 *
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
	...
	public void adjustColumn(final int column) {
		...
		int colHeadW = getColumnHeaderWidth(column);
		int colDataW = getColumnDataWidth(column);
		int prefW = Math.max(colHeadW, colDataW);
		updateTableColumn(column, prefW);
	}
	...
	/**
	 * Action class to adjust or restore the width of a single column or all columns
	 */
	class ColumnAction extends AbstractAction {

		private final boolean isSelectedColumn, isAdjust;
	...
	/**
	 * Toggle action properties of the TableColumnAdjuster so the user can customize the
